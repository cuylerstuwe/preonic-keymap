...
[_QWERTY] = LAYOUT_preonic_grid( \
  ...
  KC_LBRC, KC_LCTL, KC_LALT, KC_LGUI, LOWER,   KC_SPC,  KC_SPC,  RAISE,   KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT  \
),
...
[_LOWER] = LAYOUT_preonic_grid( \
  ...
  MI_C, _______, _______, _______, _______, _______, _______, _______, KC_MNXT, KC_VOLD, KC_VOLU, KC_MPLY \
),
